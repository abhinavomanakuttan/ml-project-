import sys
from src.logger import logging   # ✅ use absolute import

def error_message_detail(error, error_detail: sys):
    _, _, exc_tb = error_detail.exc_info()
    file_name = exc_tb.tb_frame.f_code.co_filename
    error_message = f"Error occurred in python script [{file_name}] line [{exc_tb.tb_lineno}] error message [{str(error)}]"
